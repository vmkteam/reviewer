<template>
  <select ref="selectEl" @change="onChange" class="px-4 py-2 text-sm font-medium text-amber-700 border border-amber-300 rounded-lg hover:bg-amber-50 transition-colors bg-white cursor-pointer">
